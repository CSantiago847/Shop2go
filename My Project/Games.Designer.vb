...
Partial Class Games
    ...
    Private Sub InitializeComponent()
        ...
        Label21 = New Label()
        Label10 = New Label()
        SpideyButton = New Button()
        Label19 = New Label()
        Label20 = New Label()
        Label23 = New Label()
        Label24 = New Label()
        PictureBox4 = New PictureBox()
        Play5button = New Button()
        Label14 = New Label()
        Label16 = New Label()
        Label7 = New Label()
        Label8 = New Label()
        ...
        Back.Location = New Point(548, 728)
        Back.Name = "Back"
        ...
        Label17.Location = New Point(347, 69)
        Label17.Name = "Label17"
        Label17.Size = New Size(247, 82)
        Label17.TabIndex = 2
        Label17.Text = "Fire it up then go full throttle faster " & vbCrLf & "and more effectively than ever " & vbCrLf & "with Acer's next evolution " & vbCrLf & "of its Nitro 5 gaming laptop."
        ' 
        ' Panel4
        ' 
        Panel4.Controls.Add(Label21)
        Panel4.Controls.Add(Label10)
        Panel4.Controls.Add(SpideyButton)
        Panel4.Controls.Add(Label19)
        Panel4.Controls.Add(Label20)
        Panel4.Controls.Add(Label23)
        Panel4.Controls.Add(Label24)
        Panel4.Controls.Add(PictureBox4)
        Panel4.Location = New Point(762, 376)
        Panel4.Name = "Panel4"
        ...
        Label21.Location = New Point(587, 171)
        Label21.Name = "Label21"
        Label21.Size = New Size(119, 45)
        Label21.TabIndex = 12
        Label21.Text = "$70.00"
        ' 
        ' Label10
        ...
        Label10.Location = New Point(340, 169)
        ...
        ' SpideyButton
        ' 
        SpideyButton.BackColor = Color.Green
        SpideyButton.Font = New Font("Segoe UI", 20.25F, FontStyle.Bold, GraphicsUnit.Point)
        SpideyButton.ForeColor = Color.White
        SpideyButton.Location = New Point(263, 278)
        SpideyButton.Name = "SpideyButton"
        SpideyButton.Size = New Size(179, 46)
        SpideyButton.TabIndex = 10
        SpideyButton.Text = "Buy now"
        SpideyButton.UseVisualStyleBackColor = False
        ' 
        ' Label19
        ' 
        ...
        Label19.Location = New Point(574, 216)
        ...
        Label20.Location = New Point(335, 214)
        ...
        Label23.Location = New Point(351, 68)
        Label23.Name = "Label23"
        Label23.Size = New Size(305, 82)
        Label23.TabIndex = 2
        Label23.Text = "Spider-Men, Peter Parker and Miles Morales, " & vbCrLf & "return for an exciting new adventure " & vbCrLf & "in the critically acclaimed " & vbCrLf & "Marvel’s Spider-Man franchise."
        ' 
        ' Label24
        ' 
        Label24.AutoSize = True
        Label24.Font = New Font("Segoe UI", 15.75F, FontStyle.Bold Or FontStyle.Underline, GraphicsUnit.Point)
        Label24.Location = New Point(423, 28)
        Label24.Name = "Label24"
        Label24.Size = New Size(233, 30)
        Label24.TabIndex = 1
        Label24.Text = "Marvel's Spider-Man 2"
        ' 
        ' PictureBox4
        ' 
        PictureBox4.Image = CType(resources.GetObject("PictureBox4.Image"), Image)
        PictureBox4.Location = New Point(26, 30)
        PictureBox4.Name = "PictureBox4"
        PictureBox4.Size = New Size(282, 233)
        ...
        ' Play5button
        ' 
        Play5button.BackColor = Color.Green
        Play5button.Font = New Font("Segoe UI", 20.25F, FontStyle.Bold, GraphicsUnit.Point)
        Play5button.ForeColor = Color.White
        Play5button.Location = New Point(263, 268)
        Play5button.Name = "Play5button"
        Play5button.Size = New Size(179, 46)
        Play5button.TabIndex = 9
        Play5button.Text = "Buy now"
        Play5button.UseVisualStyleBackColor = False
        ' 
        ' Label14
        ' 
        ...
        Label7.Location = New Point(557, 218)
        Label7.Name = "Label7"
        ...
        Label8.Location = New Point(289, 218)
        Label8.Name = "Label8"
        ...
        Label11.Location = New Point(289, 42)
        Label11.Name = "Label11"
        Label11.Size = New Size(367, 122)
        Label11.TabIndex = 2
        ...
        Label12.Size = New Size(261, 30)
        Label12.TabIndex = 1
        Label12.Text = "The Witcher 3: Wild hunt"
        ' 
        ' PictureBox2
        ' 
        ...
        PictureBox2.Size = New Size(200, 260)
        ...
        Label6.Location = New Point(587, 219)
        Label6.Name = "Label6"
        ...
        Label2.Location = New Point(306, 89)
        Label2.Name = "Label2"
        Label2.Size = New Size(411, 62)
        Label2.TabIndex = 2
        Label2.Text = "The fastest, most powerful Xbox ever, the XB1 Xbox Series X " & vbCrLf & "Console has the power to power your dreams. " & vbCrLf & "Optimized for Series X"
        ' 
        ' Label1
        ' 
        ...
        Label1.TabIndex = 1
        Label1.Text = "Xbox Series X" & vbCrLf
        ' 
        ' PictureBox1
        ' 
        ...
        ' Panel3
        ' 
        Panel3.Controls.Add(Play5button)
        ...
        Label18.Location = New Point(351, 28)
        Label18.Name = "Label18"
        Label18.Size = New Size(150, 28)
        Label18.TabIndex = 1
        Label18.Text = " PlayStation 5 "
        ' 
        ' PictureBox3
        ' 
        PictureBox3.Image = CType(resources.GetObject("PictureBox3.Image"), Image)
        PictureBox3.Location = New Point(84, 28)
        PictureBox3.Name = "PictureBox3"
        PictureBox3.Size = New Size(187, 233)
        ...
        Panel2.Controls.Add(WitchButton)
        ...
        Label9.Location = New Point(557, 169)
        Label9.Name = "Label9"
        ...
        Label4.Location = New Point(289, 174)
        Label4.Name = "Label4"
        ...
        ' WitchButton
        ' 
        WitchButton.BackColor = Color.Green
        WitchButton.Font = New Font("Segoe UI", 20.25F, FontStyle.Bold, GraphicsUnit.Point)
        WitchButton.ForeColor = Color.White
        WitchButton.Location = New Point(251, 278)
        WitchButton.Name = "WitchButton"
        WitchButton.Size = New Size(179, 46)
        WitchButton.TabIndex = 10
        WitchButton.Text = "Buy now"
        WitchButton.UseVisualStyleBackColor = False
        ' 
        ' Panel1
        ' 
        Panel1.Controls.Add(Xboxbutton)
        ...
        ' Xboxbutton
        ' 
        Xboxbutton.BackColor = Color.Green
        Xboxbutton.Font = New Font("Segoe UI", 20.25F, FontStyle.Bold, GraphicsUnit.Point)
        Xboxbutton.ForeColor = Color.White
        Xboxbutton.Location = New Point(251, 267)
        Xboxbutton.Name = "Xboxbutton"
        Xboxbutton.Size = New Size(179, 47)
        Xboxbutton.TabIndex = 7
        Xboxbutton.Text = "Buy now"
        Xboxbutton.UseVisualStyleBackColor = False
        ' 
        ' Games
        ' 
        AutoScaleDimensions = New SizeF(7F, 15F)
        AutoScaleMode = AutoScaleMode.Font
        ClientSize = New Size(1507, 806)
        Controls.Add(Back)
        Controls.Add(Panel4)
        Controls.Add(Panel3)
        Controls.Add(Panel2)
    ...
    Friend WithEvents SpideyButton As Button
    Friend WithEvents Label19 As Label
    Friend WithEvents Label20 As Label
    Friend WithEvents Label23 As Label
    Friend WithEvents Label24 As Label
    Friend WithEvents PictureBox4 As PictureBox
    Friend WithEvents Play5button As Button
    ...
    Friend WithEvents WitchButton As Button
    Friend WithEvents Panel1 As Panel
    Friend WithEvents Xboxbutton As Button
